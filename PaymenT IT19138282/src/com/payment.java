...
public class payment {
	...
	public String insertpayment(String amount, String date, String accountNo, String paymentType) 
	 ...
	 String query = " insert into payment (`PaymentID`,`amount`,`date`,`accountNo`,`paymentType`)"
	 + " values (?, ?, ?, ?, ?)"; 
	...
	{ 
		 ...
		 // create a prepared statement
		 String query = "UPDATE payment SET amount=?,date=?,accountNo?,paymentType=? WHERE PaymenetID=?"; 
		 PreparedStatement preparedStmt = con.prepareStatement(query); 
		 // binding values
	...
	public String deletepayment(String paymentID) 
	 ...
	 // create a prepared statement
	 String query = "delete from item where paymentID=?"; 
	 PreparedStatement preparedStmt = con.prepareStatement(query); 
	 // binding values
